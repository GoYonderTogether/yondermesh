...
> **Auto-generated** from `src/adapters/registry.ts`. Do not edit by hand — run `npm run sync` in `site/` to regenerate.

## Coverage at a glance

| Metric | Count | Meaning |
|---|---|---|
| Registered | **32** | Total CLI adapters in the registry |
| Harvest | **27** | Have a session importer (`ymesh scan`) |
| Mountable | **30** | Can receive MCP / skill / plugin mounts |
| Send-reachable | **26** | Reachable by synchronous `send` (non-empty trigger channels) |
| Coverage A / B / C | **22 / 9 / 1** | Native / wrapper / extractor-only |
...
| CLI | Coverage | Send | Adapter dir | Notes |
|---|---|---|---|---|
